(function() {
	...
	angular
		...
		function YouthCouchPriceGetController(youth_couch, width, length, sapot_noar_half_width, sapot_noar_half_length, sapot_noar_polynoa_width, sapot_noar_spolyron_width, $http, $scope) {
